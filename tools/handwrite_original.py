...
JOBS = [
    ("image1 (1).jpeg", (92, 140, 2644, 2520), {
        (1, 1): ("실", -0.19,  0.17, 0), (1, 2): ("사",  0.19,  0.17, 0),
        (2, 1): ("해", -0.19, -0.17, 0), (2, 2): ("세",  0.19, -0.17, 0)}),
    ("image2.jpeg", (172, 172, 2672, 2628), {
        (0, 0): ("봐",  0.19,  0.17,  0), (0, 3): ("현", -0.19,  0.17, 45),
        (3, 0): ("계",  0.19, -0.17, 45), (3, 3): ("조", -0.19, -0.17, 30)}),
    ("image0 (1).jpeg", (0, 0, 2424, 2248), {
        (0, 0): ("현",  0.19,  0.17, 0), (0, 3): ("조", -0.19,  0.17, 0),
        (3, 0): ("봐",  0.19, -0.17, 0), (3, 3): ("계", -0.19, -0.17, 0),
        (1, 1): ("실", -0.19,  0.18, 0), (1, 2): ("사",  0.19,  0.18, 0),
        (2, 1): ("해", -0.19, -0.18, 0), (2, 2): ("세",  0.19, -0.18, 0)}),
]
...
def run(src, dst, box, cells):
    ...
    for (r, c), (ko, dx, dy, rot) in cells.items():
        ...
        g = g.rotate(rot + rnd.uniform(-8, 8), resample=Image.BICUBIC)
